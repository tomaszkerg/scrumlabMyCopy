    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <form method="get" action="/app/schedule/edit">
                    <div class="row border-bottom border-3 p-1 m-1">
                        <div class="col noPadding">
                            <h3 class="color-header text-uppercase">NOWY PLAN</h3>
                        </div>
                        <div class="col d-flex justify-content-end mb-2">
                            <button type="submit" value="${plan.id}" name="id" class="btn btn-warning rounded-2 m-1">Zapisz</button>
                        </div>
                    </div>
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" id="planDescription" name="description" placeholder="Opis planu">${plan.description}</textarea>
                            </div>
                        </div>
