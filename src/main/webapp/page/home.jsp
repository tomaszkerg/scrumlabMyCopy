...
<section style="background-color: #4b4c4a" class="padding-large">
    <div id="carouselExampleControls" class="carousel slide main-slider" data-ride="carousel">
        <div class="carousel-inner container">
            <div class="carousel-item active">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block" style=" display: inline-flex; align-items: center; justify-content: center">
                        <img height="450px" width="650px" src="images/meal2.jpg">
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block">
                        <img height="450px" width="650px" src="images/meal1.jpg">
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block">
                        <img height="450px" width="650px" src="images/meal3.jpg">
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block">
                        <img height="450px" width="650px" src="images/meal4.jpg">
                    </div>
                </div>
            </div>
        </div>
