...
@WebServlet("/app/recipe/schedule/add")
public class RecipeAddScheduleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("recipe", recipeDao.read(id));
        ...
        getServletContext().getRequestDispatcher("/app/recipeAddSchedule.jsp").forward(req, resp);
    }
