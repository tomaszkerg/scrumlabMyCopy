...
INSERT INTO owners (name, adress, telefon, email) VALUES ('T,M,K i O', 'ul. Bezgranicznego planowania jedzenia 2/3', '309120990', 'gotujznami@mezczyznami.pl')

INSERT INTO contact(name,email,message) VALUES ('Michał R', 'michal@jakis.tam', 'Czy skończylismy już projekt?');

INSERT INTO about(`desc`)VALUE(' <strong><b>Co robimy w Diet Planner?</strong><br><br></b>

 Diet Planner powstał dzięki ambicji dużej, międzynarodowej firmy oferującej unikalny na skalę światową produkt. Produkt ten ma rozwiązywać realne problemy branży dietetycznej.<br>
 Chcemy aby...<br><br>

     - ludzie czuli się lepiej i byli zdrowi <br>
     - dietetycy mieli więcej czasu na diagnozę i wnioski <br>
     - dietetycy mogli pomóc większej liczbie pacjentów <br>
     - dietetycy nie musieli godzinami układać jadłospisów <br>
     - oprogramowanie wspierało wszystkich <br>
                              ');