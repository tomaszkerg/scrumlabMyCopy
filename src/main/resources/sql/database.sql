...
CREATE TABLE IF NOT EXISTS `scrumlab`.`owners` (
                                                   `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
                                                   `name` VARCHAR(245) NULL COMMENT 'Nazwa',
                                                   `adress` VARCHAR(245) NULL COMMENT 'Adres',
                                                   `telefon` VARCHAR(245) NULL COMMENT 'Telefon',
                                                   `email` VARCHAR(245) NULL COMMENT 'Adres email',
                                                   PRIMARY KEY (`id`))
    ENGINE = InnoDB
    COMMENT = 'Tabela zawierająca dane właścicieli';

CREATE TABLE IF NOT EXISTS `scrumlab`.`contact` (
                                                   `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
                                                   `name` VARCHAR(245) NULL COMMENT 'Nazwa',
                                                   `email` VARCHAR(245) NULL COMMENT 'Email',
                                                   `message` TEXT NULL COMMENT 'Wiadomość',
                                                   PRIMARY KEY (`id`))
    ENGINE = InnoDB
    COMMENT = 'Tabela zawierająca dane z formularza kontaktowego';

 CREATE TABLE IF NOT EXISTS `scrumlab`.`about` (
                                                    `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
                                                    `desc` TEXT NULL COMMENT 'Wiadomość',
                                                    PRIMARY KEY (`id`))
    ENGINE = InnoDB
    COMMENT = 'Tabela zawierająca opis';
